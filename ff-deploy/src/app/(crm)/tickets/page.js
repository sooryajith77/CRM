...
export default function TicketsPage() {
  ...
  const emptyMessage = "Create Tickets...";
  ...
  const handleExport = () => {
    ...
    let headers = ["ticket_name", "description", "ticket_status", "source", "priority", "company_id", "deal_id", "created_at"];
  ...
  const checkDisabledRow = (row) => {
    return false; // No constraints for tickets yet
  };
